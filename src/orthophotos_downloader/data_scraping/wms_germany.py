...
class HE_RGB_Dop20_ImageDownloader(ImageDownloader):
    ...
    def __init__(self, grid_spacing: int):
        ...
        # Define the parameters specific for the DOP20 WMS
        wms = ExtendedWebMapService(
            url="https://www.gds-srv.hessen.de/cgi-bin/lika-services/ogc-free-images.ows?language=ger&version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=wms_he_dop&format=image/png&STYLE=inspire_common:DEFAULT",
            version="1.3.0",
            resolution=0.2,
